...
namespace InitialCore.Service.Implementation
{
    public class UserService : IUserService
    {
        ...
        public async Task<bool> AddAsync(ApplicationUserViewModel userVm)
        {
            ...
            if (result.Succeeded && userVm.Roles.Count > 0)
            {
                ...
                if (ApplicationUser != null)
                    await _userManager.AddToRolesAsync(ApplicationUser, userVm.Roles);
        ...
        {
            return await _userManager.Users.ProjectTo<ApplicationUserViewModel>().ToListAsync();
        }

        public PagedResult<ApplicationUserViewModel> GetAllPagingAsync(string keyword, int page, int pageSize)
        {
            ...
            var data = query.Select(x => new ApplicationUserViewModel()
            {
                UserName = x.UserName,
                Avatar = x.Avatar,
            ...
            var paginationSet = new PagedResult<ApplicationUserViewModel>()
            {
                Results = data,
                CurrentPage = page,
                RowCount = totalRow,
