...
namespace InitialCore.Service.Implementation
{
    public class RoleService : IRoleService
    {
        ...
        public RoleService(RoleManager<ApplicationRole> roleManager, IUnitOfWork unitOfWork,
        ...
        public PagedResult<ApplicationRoleViewModel> GetAllPagingAsync(string keyword, int page, int pageSize)
        {
            ...
            var data = query.ProjectTo<ApplicationRoleViewModel>().ToList();
            var paginationSet = new PagedResult<ApplicationRoleViewModel>()
            {
                Results = data,
                CurrentPage = page,
                RowCount = totalRow,
        ...
        public async Task<ApplicationRoleViewModel> GetById(Guid id)
        {
            var role = await _roleManager.FindByIdAsync(id.ToString());
            return Mapper.Map<ApplicationRole, ApplicationRoleViewModel>(role);
        }
